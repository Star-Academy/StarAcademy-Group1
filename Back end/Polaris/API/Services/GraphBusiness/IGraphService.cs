...
namespace API.Services.GraphBusiness
{
    ...
    {
        GraphContainer<TNodeId, TNodeData, TEdgeId, TEdgeData> GetExpansion(TNodeId nodeId, bool source = false, bool target = false, string[] filter = null, Pagination pagination = null);
